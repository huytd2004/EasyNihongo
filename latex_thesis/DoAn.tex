...
\usepackage{outlines} % Hỗ trợ outline trong phụ lục
...
\def \TITLE{Hệ thống thông minh hỗ trợ học tiếng Nhật}
\def \AUTHOR{TRẦN DOÃN HUY}
...
\nocite{vue-docs,vite-guide,tailwind-docs,pinia-docs,axios-docs,spring-boot-docs,spring-security-docs,jwt-rfc7519,postgresql-docs,neo4j-cypher-manual,fastapi-docs,gemini-api-docs,sudachipy-docs,radford2023whisper,wozniak1990optimization,lewis2020rag,web-speech-api,yang2025qwen3}
\printbibliography
