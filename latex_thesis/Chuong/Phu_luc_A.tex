...
Áp dụng cách liệt kê theo quy định của IEEE. Cụ thể, sinh viên sử dụng lệnh \verb!\cite{}! để trích dẫn tài liệu trong nội dung báo cáo. Tài liệu tham khảo cần có nguồn gốc rõ ràng và phải từ nguồn đáng tin cậy. Hạn chế trích dẫn tài liệu tham khảo từ các website không chính thống hoặc Wikipedia.
