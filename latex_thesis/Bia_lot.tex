...
{\textbf{\Large{Xây dựng hệ thống học ngoại ngữ thông minh dựa trên vòng lặp học tập cá nhân hóa và thuật toán lặp lại ngắt quãng SM2}}\\[1cm]

{\textbf{\large{TRẦN DOÃN HUY}}}\\
{\large{Huy.TD225859@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Nguyễn Nhất Hải \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
